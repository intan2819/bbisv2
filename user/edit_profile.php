  ...
  <body>
    ...
    <div class="container page-container">
      ...
      <?php
        ...
        if(isset($_SESSION['profileEditSuccess'])){

          echo "<div class='alert alert-success' role='alert'>".$_SESSION['profileEditSuccess']."</div>";
          unset($_SESSION['profileEditSuccess']);
      ...
      <form method="POST" action="edit_profile_process.php">
        ...
        <div class="form-group">
          ...
          <input type="email" class="form-control" id="emailAddress" placeholder="Email Address" name="emailAddress" value="<?php echo $emailAddress; ?>" disabled>
        </div>

        <div class="form-group">
          <label for="username">Username</label>
          <input type="text" class="form-control" id="username" placeholder="Username" name="username" value="<?php echo $username; ?>" disabled>
        </div>

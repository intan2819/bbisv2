  ...
  <body>
    ...
    <div class="container page-container">
      ...
      <?php
        ...
        if(isset($_SESSION['userRegistrationSuccess'])){

          echo "<div class='alert alert-success' role='alert'>".$_SESSION['userRegistrationSuccess']."</div>";
          unset($_SESSION['userRegistrationSuccess']);

        }

        if(isset($_SESSION['userDeleted'])){

          echo "<div class='alert alert-danger' role='alert'>".$_SESSION['userDeleted']."</div>";
